...
;SignTool=MsSign $f
;Encryption=yes
AppID={{D7D4CDFA-A81A-4517-BCE9-F4A18CC9817F}
AppName=ASCOM Wanderer Rotator by photon
AppVersion={#myAppVersion}
AppVerName="ASCOM Wanderer Rotator by photon1{#myAppVersion}"
...
OutputDir="."
OutputBaseFilename=" Wanderer Rotator by photon Setup {#myAppVersion}"
Compression=lzma
SolidCompression=yes
; Put there by Platform if Driver Installer Support selected
;WizardImageFile="C:\Program Files (x86)\ASCOM\Platform 6 Developer Components\Installer Generator\Resources\WizardImage.bmp"
LicenseFile="C:\git\WandererRotator\LICENSE"
; {cf}\ASCOM\Uninstall\Telescope folder created by Platform, always
UninstallFilesDir="{cf}\ASCOM\Uninstall\Rotator\WandererRotatorByPhoton"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\UninstallRotator\WandererRotatorByPhoton"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\WandererRotator\WandererRotator\bin\Debug\ASCOM.photonWanderer.exe"; DestDir: "{app}"
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonWanderer.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonWanderer.exe"; Parameters: "/unregister"
